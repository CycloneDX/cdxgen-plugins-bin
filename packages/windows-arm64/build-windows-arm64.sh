...
wget https://github.com/osquery/osquery/releases/download/5.12.2/osquery-5.12.2.windows_arm64.zip
unzip osquery-5.12.2.windows_arm64.zip
cp "osquery-5.12.2.windows_arm64/Program Files/osquery/osqueryi.exe" plugins/osquery/osqueryi-windows-arm64.exe
sha256sum plugins/osquery/osqueryi-windows-arm64.exe > plugins/osquery/osqueryi-windows-arm64.exe.sha256
rm -rf osquery-5.12.2.windows_arm64
rm osquery-5.12.2.windows_arm64.zip
