...
wget https://github.com/osquery/osquery/releases/download/5.11.0/osquery-5.11.0.windows_x86_64.zip
unzip osquery-5.11.0.windows_x86_64.zip
cp "osquery-5.11.0.windows_x86_64/Program Files/osquery/osqueryi.exe" plugins/osquery/osqueryi-windows-amd64.exe
...
rm -rf osquery-5.11.0.windows_x86_64
rm osquery-5.11.0.windows_x86_64.zip
