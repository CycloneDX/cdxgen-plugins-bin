...
wget https://github.com/osquery/osquery/releases/download/5.14.1/osquery-5.14.1_1.linux_aarch64.tar.gz
tar -xvf osquery-5.14.1_1.linux_aarch64.tar.gz
...
rm osquery-5.14.1_1.linux_aarch64.tar.gz
