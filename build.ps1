...
upx-4.0.2-win64\upx.exe -9 --lzma plugins\osquery\osqueryi-windows-amd64.exe
...
..\..\upx-4.0.2-win64\upx.exe -9 --lzma build\goversion-windows-amd64.exe
...
..\..\upx-4.0.2-win64\upx.exe -9 --lzma build\cargo-auditable-windows-amd64.exe
