...
Invoke-WebRequest -Uri https://github.com/osquery/osquery/releases/download/5.13.1/osquery-5.13.1.windows_x86_64.zip -UseBasicParsing -OutFile osquery-5.13.1.windows_x86_64.zip
Expand-Archive -Path osquery-5.13.1.windows_x86_64.zip -DestinationPath . -Force
copy "osquery-5.13.1.windows_x86_64\Program Files\osquery\osqueryi.exe" plugins\osquery\osqueryi-windows-amd64.exe
...
Remove-Item osquery-5.13.1.windows_x86_64 -Recurse -Force
Remove-Item osquery-5.13.1.windows_x86_64.zip -Recurse -Force
